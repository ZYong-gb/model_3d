...
model = AutoModel.from_pretrained("facebook/vfusion3d", trust_remote_code=True)
processor = AutoProcessor.from_pretrained("facebook/vfusion3d")
...
image_path = "../../../images/photo_man/2.jpg"
